...
public class PermissoesDAO {
    ...
    public void popularTabela(JTable tabela, String criterio) {
        ...
        cabecalho[2] = "VisualizarTela";
        cabecalho[3] = "EdiçãoRegistros";
        cabecalho[4] = "InclusãoRegistros";
        cabecalho[5] = "ExclusãoRegistros";
        cabecalho[6] = "ConsultaRegistros";
        ...
        try {
            ...
            for (Object o : resultado) {
                ...
                dadosTabela[lin][2] = p.getPermissaovisibilidadetela();
                dadosTabela[lin][3] = p.getPermissaoedicaotela();
                dadosTabela[lin][3] = p.getPermissaobtnexclusao();
                dadosTabela[lin][3] = p.getPermissaoconsulta();
