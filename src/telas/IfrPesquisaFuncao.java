 ...
 */
public class IfrPesquisaFuncao extends javax.swing.JDialog {

    IfrUsuario u;

    public IfrPesquisaFuncao(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public IfrPesquisaFuncao(java.awt.Frame parent, boolean modal, IfrUsuario user) {
        initComponents();
        this.u = user;
    ...
    private void tbnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tbnOkActionPerformed
        if (tblFuncoes.getSelectedRowCount() == 1) {
            u.pegaIdDlg2(String.valueOf(tblFuncoes.getValueAt(tblFuncoes.getSelectedRow(), 0)));
            dispose();
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IfrPesquisaFuncao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IfrPesquisaFuncao dialog = new IfrPesquisaFuncao(new javax.swing.JFrame(), true);
