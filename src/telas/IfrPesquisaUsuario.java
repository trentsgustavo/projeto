 ...
 */
public class IfrPesquisaUsuario extends javax.swing.JDialog {
     ...
     *
     */
    public IfrPesquisaUsuario(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public IfrPesquisaUsuario(java.awt.Frame parent, boolean modal, IfrRestricoes user) {
        initComponents();
        this.u = user;
        ...
        UsuarioDAO p;
        p = new UsuarioDAO();
        p.popularTabela(tblUsuario, "");
    }

    public IfrPesquisaUsuario(java.awt.Frame parent, boolean modal,IfrPedido ped) {
        initComponents();
        this.p = ped;
        Dimension dim = Toolkit.getDefaultToolkit().getScreenSize();
        this.setLocation(dim.width / 2 - this.getSize().width / 2, dim.height / 2 - this.getSize().height / 2);
    ...
    private void tbnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tbnOkActionPerformed
        if (tblUsuario.getSelectedRowCount() == 1) {
            u.pegaIdDlg2(String.valueOf(tblUsuario.getValueAt(tblUsuario.getSelectedRow(), 0)));
            dispose();
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IfrPesquisaUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IfrPesquisaUsuario dialog = new IfrPesquisaUsuario(new javax.swing.JFrame(), true);
