 ...
 */
public class IfrPesquisaUsuario2 extends javax.swing.JDialog {
     ...
     *
     */
    public IfrPesquisaUsuario2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }


    public IfrPesquisaUsuario2(java.awt.Frame parent, boolean modal,IfrPedido ped) {
        initComponents();
        this.p = ped;
    ...
    private void tbnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tbnOkActionPerformed
        if (tblUsuario.getSelectedRowCount() == 1) {
            p.pegaIdDlg(String.valueOf(tblUsuario.getValueAt(tblUsuario.getSelectedRow(), 0)));
            dispose();
        } else {
            JOptionPane.showMessageDialog(this, "Você deve primeiro selecionar um usuário!");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IfrPesquisaUsuario2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                IfrPesquisaUsuario2 dialog = new IfrPesquisaUsuario2(new javax.swing.JFrame(), true);
