...
public class FormatarCampos {
    ...
    public static JFormattedTextField getDataHoraBD() {
        return getFormatado("##_##_####_##-##");
    }

    public static JFormattedTextField getPlaca() {
        return getFormatado("UUU-####");
    }
    ...
    public static String getDataHoraAtualBD() {
        Date now = new Date();
    ...
    public static Date DataMySQL(String data) {
        Date dia = new Date();
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
        try {
            dia = formatter.parse(data);
